...
syntax using/, time_elasticity(string) [bilat_predict(string)] fe_i(string) fe_j(string) r2p(string)
...
gen r2 = `r2p_value'
export delimited r2 using `r2p', replace novarnames
// FEs
