...
slopes, intercepts and MSEs when regressing the continuum changes 
on predicted changes across 100 simulations, population size, magnitudes of lambda and productivity shocks.
...
* `prediction_{cbm,csp}%.csv`: stores the counterfactual predictions for changes in prices and quantities from CBM and CSP models