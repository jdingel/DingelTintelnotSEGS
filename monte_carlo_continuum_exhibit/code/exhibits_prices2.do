...
//Load data
use "../input/sum_continuum_prices_`1'_2.488905_`2'.dta", clear
gen pop = 2.488905
foreach pop in 5 12.5 25 50 125 250 2560 {
	append using "../input/sum_continuum_prices_`1'_`pop'_`2'.dta"
	replace pop = `pop' if pop == .
}

// Report summary statistics for predictions by varying population size
gen ratio_MSE = mse_cbm / mse_csp
replace mse_cbm = mse_cbm * 1e10
replace mse_csp = mse_csp * 1e10
...
frmttable using "../output/sumstats_continuum_prices_`1'_`2'.tex", replace ///
