...
local popu = 2.488905
use "../input/sum_continuum_labor_`1'_`popu'_`3'.dta", clear
gen pop = `popu'
...
shell echo -n `slope_csp_median' > "../output/csp_slope_median_continuum_labor_`1'_`popu'_`3'.tex"
shell echo -n `intercept_csp_median' > "../output/csp_intercept_median_continuum_labor_`1'_`popu'_`3'.tex"
...
shell mv "../output/slopes_intercepts_densities_continuum_labor.eps" ///
	"../output/slopes_intercepts_densities_continuum_labor_`1'_`popu'_`3'.eps"
...
shell echo -n `mse_ratio_median' > "../output/mse_ratio_median_continuum_labor_`1'_`popu'_`3'.tex"
local mse_ratio_sd = string(`r(sd)', "%4.2f")
shell echo -n `mse_ratio_sd' > "../output/mse_ratio_sd_continuum_labor_`1'_`popu'_`3'.tex"
