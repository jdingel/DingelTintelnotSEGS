...
alpha = 0.24
sigma = 4.0
eta = parse(Float64, ARGS[1])
@assert eta ∈ [0.001, 0.0028, 0.1]
zeta = 1.0
...
save("../output/baseline_equilibrium_outcomes_eta_"*string(eta)*".jld2", "CommutingFlows", ell_kn_b, "rents", cont_r_b[:], "wages", cont_w_b[:])