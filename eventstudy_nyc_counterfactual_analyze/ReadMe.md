...
This task takes approximately 30 seconds per specification and is parallelizable.
...
* `nyc2012_lodes_wzeros.dta`:
Reports the number of commuters in 2012 for 4.6 million pairs of tracts.
