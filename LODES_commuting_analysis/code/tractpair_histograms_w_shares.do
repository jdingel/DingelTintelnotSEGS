...
graph twoway (hist X_ij_topcoded, start(1) width(1) lcolor(blue) color(white) fraction graphregion(color(white)) yaxis(1)) ///
        ...
        xlabel(0(`stepsize')`topcodevalue',labsize(*`labsizeinflate')) ylabel(0(0.2)1, format(%3.1f) labsize(*`labsizeinflate') axis(1)) ylabel(0(0.2)1, format(%3.1f) labsize(*`labsizeinflate') axis(2)) /// 
